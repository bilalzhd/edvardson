...
export default async function Home() {
  ...
  return (
    <>
      ...
      <div className='px-[1.25rem] max-w-[70rem] mx-auto py-4 min-h-screen'>
      ...
      <div className='flex px-[1.25rem]'>
        ...
        <div className='w-1/2'>
          <img className='max-h-[400px] w-full object-cover' src="https://fengel-b2b-apigateway-prod.azurewebsites.net/cms-api/media/1223542f-6f63-4eb3-a8a7-e11e1e9c6847?key=block-square-large" alt="Edvardson About" />
        </div>

      </div>
      <div className='max-w-[70rem] mx-auto letter-spacing-0 mt-20 mb-10'>
      ...
      <div className='max-w-[70rem] mx-auto flex flex-col items-center justify-center gap-5 border-t py-10'>

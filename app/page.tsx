  ...
  return (
    <>
      <div className='relative py-4'>
        ...
        <div className='bg-[#00030A] relative flex justify-center flex-col text-white p-4 bg-[url("/images/edddd.webp")] bg-contain min-h-[25rem] bg-no-repeat md:min-h-[35rem]'>

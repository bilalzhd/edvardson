  ...
  return (
    <>
      <div className='relative pb-4'>
        <div className='bg-[#00030A] relative flex justify-center flex-col text-white p-4 2xl:bg-[url("/images/wood_bg.jpg")] bg-[url("/images/wood_bg.jpg")] min-h-[30rem] bg-repeat md:min-h-[35rem] bg-pos-x-xl'>
          <div className='absolute inset-0 bg-black/40 flex justify-center items-center'>
            <div className='md:max-w-4xl px-[1.5rem] md:px-0'>
              <h3 className='text-[44px] md:text-[48px] font-bold'>Välkommen till Edvardson Sweden</h3>
              <p className='mt-4 text-[#bdbdbd] text-md font-open letter-spacing-0 leading-6 md:block hidden'>Edvardson Sweden är ett anrikt familjeföretag, tidigare känt som Malungsfors Läderprodukter. Det började på 1860-talet då farfars farfar Edvard Torstensson började med skomakeri för att livnära sig. Sedan dess har tillverkningen utökats till att även innefatta jakttillbehör och friluftstillbehör i läder.</p>
            </div>
          </div>
        </div>
      ...
      <div className='xl:max-w-[80%] 2xl:max-w-[80%] lg:w-full mx-auto py-4 min-h-screen'>
        <div className='px-[10px]'>
          <h2 className='uppercase font-bold text-2xl md:text-[2.125rem] leading-[1.1] mb-2'>Veckans erbjudande</h2>
      ...
      <div className='bg-[#E5FFEA] mb-12'>
        <div className='flex md:flex-row flex-col-reverse xl:max-w-[80%] 2xl:max-w-[80%] mx-auto'>
          ...
          <div className='md:w-1/2 py-[30px] px-3 md:px-0'>
            <Image src="/images/product-bg-edvardson.jpg" height={450} width={510} className='w-full max-h-[450px] object-cover' alt='Edvardson About' />
          </div>


        </div>
      </div>
      {/* <div className='xl:max-w-[80%] 2xl:max-w-[80%] mx-auto letter-spacing-0 mt-20 mb-10'>
      ...
      <div className='mb-12 relative bg-[url("/images/edvardsonproducts.jpg")] bg-center text-white xl:max-w-[80%] 2xl:max-w-[80%] mx-auto flex flex-col items-center justify-center gap-5 border-t py-10'>

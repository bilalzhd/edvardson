    ...
    <>
      ...
      <footer className="bg-black pt-8 pb-4">
        <div className='border-b border-white pb-8 mx-4 mb-10 md:pl-6 flex items-center'>
          <Image width={200} height={50} src="/images/edvardsonlogow.png" alt="Edvardson" className='w-52' />
        </div>
        <div className="gap-10 md:gap-0 border-b border-white pb-12 flex flex-col items-center md:flex-row md:px-4 md:mx-4 text-white text-[13px]">
          ...
          <div className="md:w-1/4 w-full px-4 flex gap-3 md:justify-center items-center">
            <a rel='nofollow' target='_blank' href='https://www.facebook.com/edvardson.se/'><Image width={50} height={50} src="/images/facebook-rounded_white.svg" alt="Facebook Icon" /></a>
            <a href='https://www.instagram.com/edvardson_sweden_ab/' rel='nofollow' target='_blank'><Image width={50} height={50} src="/images/instagram-rounded_white.svg" alt="Instagram Icon" /></a>
          </div>
          <div className="md:w-1/4 w-full px-4 flex md:justify-center">
            <Image height={82} width={250} className="max-w-[250px] object-contain" src="https://cdn.klarna.com/1.0/shared/image/generic/badge/sv_se/checkout/short-white.png?width=510" alt="Klarna Payment" />
          </div>
        </div>
